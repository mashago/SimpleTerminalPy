...
<img src="screenshots/keymap1.jpg" alt="Key Calibration 1" width="400"/>
<img src="screenshots/keymap2.jpg" alt="Key Calibration 2" width="400"/>
...
- Press the **🌐** key (labeled `中`) at the bottom-left to enter pinyin mode (`EN` label), press again to return
